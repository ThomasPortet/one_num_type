...
\begin{itemize}
\item Some functions take more than one argument such as binomial coefficients :
 \begin{small}
\begin{verbatim}
...
\begin{frame}[fragile]
 ...
 \item To handle functions with an arbitrary number of arguments, we introduce a \emph{new family of types}: \texttt{ty\_ T n}.
 \begin{verbatim}
